...
#define SELECT_ROOM5_ADMIN      (uint8)'2'
#define SELECT_TV               (uint8)'3'
#define ADMIN_MORE_OPTION1      (uint8)'4'

#define SELECT_AIR_CONDITIONING (uint8)'1'
#define ADMIN_RET_OPTION        (uint8)'2'
...
#define ROOM5_MENU           (uint8)7
#define TV_MENU              (uint8)8
#define AIRCONDITIONING_MENU (uint8)9
#define AIRCOND_CTRL_MENU    (uint8)10
#define TEMPERATURE_MENU     (uint8)11
#define AIR_COND_MENU        (uint8)12
