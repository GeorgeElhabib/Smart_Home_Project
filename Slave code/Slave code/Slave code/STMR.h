...
/*
	Function Name        : timer1_wave_fastPWM_A
	Function Returns     : void
...
/*
	Function Name        : timer1_wave_fastPWM_B
	Function Returns     : void
	Function Arguments   : double
	Function Description : initialize the generation of a wave on OC1B pin in fast PWM mode.
*/
